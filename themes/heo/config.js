const CONFIG = {
  ...
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'ZHULINZ.TOP',
  HERO_TITLE_4: 'Hello World',
  HERO_TITLE_5: '',
  HERO_TITLE_LINK: 'https://blog.zhulinz.top',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '必看精选', url: '/tag/必看精选' },
  HERO_CATEGORY_2: { title: '热门文章', url: '/tag/热门文章' },
  HERO_CATEGORY_3: { title: '书单指南', url: '/booksGuide' },
  ...
  INFO_CARD_URL: 'https://github.com/xuliyaheizi/NotionBlog/tree/deploy', // 个人资料底部按钮链接
